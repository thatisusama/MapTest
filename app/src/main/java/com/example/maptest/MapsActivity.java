...
public class MapsActivity extends AppCompatActivity implements
    ...
    protected void onStart() {
        ...
        fleet = findViewById(R.id.fleet);
        fleet.setText(MySharedPrefClass.getPrefString("fleet", MapsActivity.this));
        client = findViewById(R.id.client);
        client.setText(MySharedPrefClass.getPrefString("client", MapsActivity.this));

        mSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                MySharedPrefClass.putPrefString("fleet", fleet.getText().toString(), MapsActivity.this);
                MySharedPrefClass.putPrefString("client", client.getText().toString(), MapsActivity.this);
            }
        });
